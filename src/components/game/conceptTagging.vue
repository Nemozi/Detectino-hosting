    ...
    const resolve = () => {
        ...
        taskType: 'concept_tagging',
        imageName: props.images ? props.images[0]?.src || props.images[0] : 'multiple_images',
        isCorrect: isUserCorrect.value,
        interactionType: `Selected: ${selectedTermIds.value.join(', ')}`
        });
