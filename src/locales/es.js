export default {
    ...
    info: {
        ...
        unsplashNote: "Esta aplicación utiliza la API de Unsplash, pero no está avalada ni certificada por Unsplash. Las imágenes generadas provienen del conjunto de datos AIS-4SD o son auto-generadas.",
        button: "¡Empezar!"
    },
    dashboard: {
        header: {
