...
level0: {
    ...
    level5: {
        ...
        step_text: {
            question: "你能找到图中不合逻辑的文字吗？",
            title: "人造文字",
            text: "你注意到了吗？背景里的文字无法辨认。这不仅是因为距离远，还因为 AI 往往无法生成真实的文字。相反，它生成的形状只是看起来像字母（即所谓的“乱码”或 gibberish）。"
        },
        step_fingers: {
            question: "哪张图片的手部解剖结构有问题？",
            title: "手指太多",
            text: "手部是 AI 模型最大的弱点之一。手指经常融合在一起，或者 AI 简单地在单手上生成六个或更多手指。不自然的弯曲也很常见。"
        },
        step_legs: {
            question: "你能看出图片底部的错误吗？",
            title: "不合常理的腿",
            text: "在全身照中，AI 经常会混淆四肢。在这里，一条腿从身体上一个解剖学上不可能的位置长了出来。"
        }
    },
    etappenQuiz: {
        intro: {
