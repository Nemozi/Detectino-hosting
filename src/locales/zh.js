...
dashboard: {
    ...
    level8: {
        ...
        feedAnalysis: {
            title: "错误细节详解",
text: `
  <p>即使是现代人工智能也经常出错。以下示例解释了其中一些常见错误：</p>
  <ul>
    <li>
      <strong>图 1 (坦克)：</strong>
      观察后视镜。从这个拍摄角度来看，镜中的反射在物理上是不可能的。
    </li>
    <li>
      <strong>图 2 (警察)：</strong>
      注意左边警察背后的文字，字母扭曲且毫无意义。
    </li>
    <li>
      <strong>图 3 (飞机)：</strong>
      机翼上的线条歪斜或相互融合，这是人工智能在处理图案时的典型错误。
    </li>
    <li>
      <strong>图 4 (化妆品)：</strong>
      镜像中的妆容与前景中的妆容不匹配。
    </li>
    <li>
      <strong>网红图片：</strong>
      技术上非常出色，但请注意账号情况：如果一个账号在短短几天内就拥有大量粉丝，这是一个警示信号。
    </li>
  </ul>
`},
    },
