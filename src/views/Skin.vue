...
// KI-Bilder Liste für das Preloading
const aiAssets = [
    ...
    { name: 'Image_0025.jpg', bucket: 'Real-Images' } // Ein echtes Bild liegt im Storage
];
...
onMounted(async () => {
    try {
        ...
        // 1. Unsplash Pool (Real-Bilder aus DB Buffer)
...
<template>
    <div class="content-wrapper">
        <div v-if="!isDataLoaded" class="loading-screen">
            ...
            <p>{{ t('level2.loading') }}</p>
        </div>

        <div v-else class="level-container">
            <template v-if="!gameFinished">
                <div class="level-header-title">{{ t('level2.title') }}</div>
            ...
            <template v-if="!gameFinished">
                ...
                <gridSelect
                    ...
                    :images="[
                        ...
                        { src: realImagesStep3[0].src, type: 'real', bucket: 'Unsplash', credit: realImagesStep3[0].credit },
                        { src: realImagesStep3[1].src, type: 'real', bucket: 'Unsplash', credit: realImagesStep3[1].credit }
                    ].sort(() => 0.5 - Math.random())" 
                    :question="t('level2.step3.question')"
                    :successText="t('level2.step3.success')"
                    :feedbackText="t('level2.step3.fail')"
                    @completed="nextStep"
                />
