    ...
    <div class="content-wrapper">
        ...
        <div v-else class="level-container">
            ...
            <template v-if="!gameFinished">
                ...
                <!-- 5-6: NEU Finger -->
                <spotTheFake v-else-if="currentStep === 5" :levelId="6" :aiImage="{ src: 'Image_0004.jpg', bucket: 'anatomy-Images' }" :realImages="realImagesStep5" :questionText="t('level5.step_fingers.question')" @completed="nextStep" />
                <analysis v-else-if="currentStep === 6" :image="[{ src: 'Image_0004.jpg', bucket: 'anatomy-Images' }, { src: 'Zoom_0004.jpg', bucket: 'anatomy-Images' }]" :title="t('level5.step_fingers.title')" :text="t('level5.step_fingers.text')" @next="nextStep" />
                ...
                <!-- 9-12: Übung -->
                <singleChoice v-else-if="currentStep === 9" :isSurvey="true" :isLocked="!solutionUnlocked" :image="getLockedImageStack('Image_0011.jpg', 'Heatmap_0011.png', 'Fake-Images')" :question="getDynamicTitle(t('level5.check_question'))" :options="[{id:'yes', text:t('level5.options.yes')}, {id:'no', text:t('level5.options.no')}]" @completed="handleSelfCheckResult" />
